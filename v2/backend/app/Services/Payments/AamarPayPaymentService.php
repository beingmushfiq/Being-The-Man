...
class AamarPayPaymentService implements PaymentProviderInterface
{
    ...
    {
        $this->storeId      = Setting::get('aamarpay_store_id',      env('AAMARPAY_STORE_ID', 'sandbox'));
        $this->signatureKey = Setting::get('aamarpay_signature_key', env('AAMARPAY_SIGNATURE_KEY', 'sandbox_key'));
        $this->baseUrl      = Setting::get('aamarpay_base_url',      env('AAMARPAY_BASE_URL', 'https://sandbox.aamarpay.com'));
    }
    ...
    public function initiatePayment(array $data): array
    {
        $response = Http::post("{$this->baseUrl}/jsonpost.php", [
            ...
            'desc'          => Setting::get('site_name', 'Being The Man') . ' book payment',
